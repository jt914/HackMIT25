            ...
            <div className="flex flex-col items-center space-y-8 text-center">
              <div className="space-y-6 animate-in fade-in-0 slide-in-from-bottom-4 duration-1000">
                ...
                <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl/none max-w-4xl">
                  Learn to Code with
                  <span className="text-orange-600 block mt-2"> CodeByte</span>
                </h1>
        ...
        <section className="w-full py-16 md:py-28 lg:py-36 bg-white">
          <div className="container px-4 md:px-6 mx-auto">
            ...
            <div className="grid gap-8 lg:grid-cols-3 lg:gap-12">
              <Card className="group border-0 shadow-lg bg-white hover:shadow-2xl hover:shadow-orange-100 transition-all duration-500 hover:-translate-y-2">
                <CardHeader className="pb-4">
                  <div className="w-16 h-16 bg-orange-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
